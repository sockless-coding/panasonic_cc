...
class FlowHandler(config_entries.ConfigFlow):
    ...
    async def _check_entry(self, username, password):
        """Register new entry."""
        ...
        return await self._create_device(username, password)
    ...
    async def async_step_user(self, user_input=None):
        ...
        return await self._check_entry(user_input[CONF_USERNAME], user_input[CONF_PASSWORD])
    ...
    async def async_step_import(self, user_input):
        ...
        return await self._check_entry(username, user_input[CONF_PASSWORD])
